...
export default {
  ...
  created() {
    request('/user/welcome', METHOD.GET).then(res => this.welcome = res)
    request('/work/activity', METHOD.GET).then(res => this.activities = res)
    request('/work/team', METHOD.GET).then(res => this.teams = res)
